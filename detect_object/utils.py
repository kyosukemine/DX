...
def visualize(
  ...
  for detection in detections:
    # Draw bounding_box
    start_point = 320-detection.bounding_box.left,  320-detection.bounding_box.top
    end_point = 320-detection.bounding_box.right, 320-detection.bounding_box.bottom
